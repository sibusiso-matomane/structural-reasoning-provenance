...
Modern AI systems produce outputs without exposing reasoning structure. This project separates generation from reasoning inspection by recording provenance as structured state.
...
Instead of evaluating only outputs, the engine tracks reasoning pathways, allowing:

- failure surface detection
- model–reality divergence analysis
...
- Separation of generation and reasoning inspection
